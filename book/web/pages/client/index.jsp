...
<body>
	...
	<div id="main">
		<div id="book">
			<div class="book_cond">
				<form id= "form_id" action="client/bookServlet?" method="get">
					<input  id = "action" type="hidden" name="action" value="pageByPrice"/>
					价格：<input id="min" type="text" name="min" value="${param.min}" /> 元 -
						<input id="max" type="text" name="max" value="${param.max}"/> 元
						<input id="queryPrice" type="submit" value="查询" />
				</form>
				...
				<div class="b_list">
					...
					<div class="book_info">
						...
						<div class="book_amount">
							...
							<span class="sp2">${book.store}</span>
						</div>
						<div class="book_add" >
